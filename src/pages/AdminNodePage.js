...
import '../styles/AdminNode/AdminNodePage.css';
  ...
  return (
    ...
    <div className="ICON"> <Icon height="20px" width="20px"/></div>
      ...
      <div className="Header__nav">
        <p className="Header__nameUser">Котиков Олег Петрович</p> 
        <p className="Header__ruleUser" >Администиратор узла</p>
    ...
    <main>
      ...
      <ul className="main__ul">
        ...
        onClick={()=>{col('col7')}}>Список членов партии <br/>  моей ветки</span></li>
